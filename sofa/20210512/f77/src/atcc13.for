      SUBROUTINE iau_ATCC13 ( RC, DC, PR, PD, PX, RV, DATE1, DATE2,
     :                        RA, DA )
*+
*  - - - - - - - - - - -
*   i a u _ A T C C 1 3
...
*
*  Returned:
*     RA,DA    d      ICRS astrometric RA,Dec (radians)
*
*  Notes:
*
...
*     iau_ATCQQ    quick catalog ICRS to astrometric
*
...
*-----------------------------------------------------------------------
      ...
      IMPLICIT NONE
      DOUBLE PRECISION RC, DC, PR, PD, PX, RV, DATE1, DATE2, RA, DA
...
*  The transformation parameters.
      CALL iau_APCI13 ( DATE1, DATE2, ASTROM, W )
