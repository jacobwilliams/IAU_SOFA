      SUBROUTINE iau_ATCCQ ( RC, DC, PR, PD, PX, RV, ASTROM, RA, DA )
*+
*  - - - - - - - - - -
*   i a u _ A T C C Q
*  - - - - - - - - - -
...
*-----------------------------------------------------------------------
      ...
      IMPLICIT NONE
      DOUBLE PRECISION RC, DC, PR, PD, PX, RV, ASTROM(30), RA, DA

      DOUBLE PRECISION P(3), W
...
*  Proper motion and parallax, giving BCRS coordinate direction.
      CALL iau_PMPX ( RC, DC, PR, PD, PX, RV, ASTROM(1), ASTROM(2), P )
